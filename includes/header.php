...
<head>
    ...
    <link rel="icon" type="image/png" href="/assets/images/favicon.png?v=<?php echo filemtime($_SERVER['DOCUMENT_ROOT'] . '/assets/images/favicon.png'); ?>">
    <link rel="apple-touch-icon" href="/assets/images/favicon.png?v=<?php echo filemtime($_SERVER['DOCUMENT_ROOT'] . '/assets/images/favicon.png'); ?>">
